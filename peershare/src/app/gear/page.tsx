    ...
    <div style={{ minHeight: '100vh', background: '#1A1714' }}>
      <div style={{ width: '100%', lineHeight: 0 }}>
        <svg width="100%" height="36" viewBox="0 0 800 36"
          ...
          <defs>
            <pattern id="clap-lg-gear" x="0" y="0" width="72" height="36" patternUnits="userSpaceOnUse">
          ...
          <rect width="800" height="36" fill="url(#clap-lg-gear)"/>
        </svg>
        <svg width="100%" height="22" viewBox="0 0 800 22"
          preserveAspectRatio="none"
          className="block sm:hidden">
          <defs>
            <pattern id="clap-sm-gear" x="0" y="0" width="44" height="22" patternUnits="userSpaceOnUse">
          ...
          <rect width="800" height="22" fill="url(#clap-sm-gear)"/>
        </svg>
      </div>
