    ...
    <div style={{ minHeight: '100vh', background: '#1A1714' }}>
      <div style={{ width: '100%', lineHeight: 0 }}>
        <svg width="100%" height="48" viewBox="0 0 800 48"
          ...
          <defs>
            <pattern id="clap-lg-hb" x="0" y="0" width="96" height="48" patternUnits="userSpaceOnUse">
          ...
          <rect width="800" height="48" fill="url(#clap-lg-hb)"/>
        </svg>
        <svg width="100%" height="30" viewBox="0 0 800 30"
          preserveAspectRatio="none"
          className="block sm:hidden">
          <defs>
            <pattern id="clap-sm-hb" x="0" y="0" width="60" height="30" patternUnits="userSpaceOnUse">
          ...
          <rect width="800" height="30" fill="url(#clap-sm-hb)"/>
        </svg>
      </div>
