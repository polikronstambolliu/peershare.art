  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/help-board/new" className="btn-primary">+ Post request</Link>
      </div>

      <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-xl p-4 mb-8 text-sm text-yellow-400/80">
      ...
      {requests?.length ? (
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <span className={`badge shrink-0 ${req.is_paid ? 'badge-yellow' : 'badge-green'}`}>
        ...
        <div className="text-center py-24 text-white/30">
          ...
          <Link href="/help-board/new" className="btn-primary inline-block">Post a request</Link>
        </div>
      )}
    </div>
  )
